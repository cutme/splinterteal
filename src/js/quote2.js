$(document).ready(function() { 
	$('#Send').click(function() {  
		...
		$.post("quote2.php?"+$("#frmquote").serialize(), {}, function(response) {
			if(response==1) {
				$("#frmres").html('<label class="success" id="after_submit">Thank you for submitting your details, we will get back to you shortly!</label>');
				change_captcha();
				clear_form();
			} else if(response==2) {
